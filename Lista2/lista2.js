...
function renderizarEventos() {
  const listaDeEventos = document.querySelector(".lista-de-eventos tbody");
  ...
  eventos.forEach((evento, índice) => {
    ...
    botaoFeito.classList.add("done-Button");
...
document.querySelector(".botao-adicionar").addEventListener("click", () => {
  const elementoDeInputNome = document.querySelector(".nome-input");
